...
import Header from "../components/header-booking"
...
function ICallEmbed() {
  ...
  React.useEffect(() => {
    (async function () {
      const cal = await getCalApi({
        namespace: "artima-business-lifestyle-visit",
      ...
      cal("inline", {
        ...
        calLink:
          "team/artima-business-lifestyle/artima-business-lifestyle-visit",
        config: {
  ...
  return (
    <Cal
      id="my-cal-inline"
      namespace="artima-business-lifestyle-visit"
      calLink="team/artima-business-lifestyle/artima-business-lifestyle-visit"
      style={{
        width: "100%",
        height: "100%",
        overflow: "scroll",

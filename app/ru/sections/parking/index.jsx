      ...
      <div className={styles.parking__inner}>
        ...
        <div className={styles.parking__list}>
          <h6 className={styles.parking__title}>
            ...
            <br />количество парковочных мест
          </h6>

          <p className={styles.parking__text}>
            Подземная парковка с {""}
            <br className="inline-block sm:hidden"/>непосредственным {""}
            <br className="hidden sm:inline-block"/>доступом в {""}
            <br className="inline-block sm:hidden"/>вестибюль
          </p>
          <p className={styles.parking__text}>
            Круглосуточная безопасность {""}
            <br className="inline-block sm:hidden"/>автомобиля обеспечивается {""}
            <br className="inline-block sm:hidden"/>оператором, который в {""}
            <br className="hidden sm:inline-block" />режиме {""}
            <br className="inline-block sm:hidden"/>реального времени наблюдает за {""}
            <br />подземной парковкой с помощью {""}
            <br className="inline-block sm:hidden"/>камер
          </p>
          <p className={styles.parking__text}>

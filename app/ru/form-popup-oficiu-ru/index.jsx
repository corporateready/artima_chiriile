...
export default function FormPopupRu({
  handleTogglePopup,
  formSubmitTrack,
  nameValue,
  emailValue,
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <svg
            className="w-[16rem] h-[16rem] hidden sm:inline-block"
            viewBox="0 0 16 16"
            fill="none"
        ...
        <motion.span
          ...
          transition={{ easings: "in-out", duration: 1, delay: 1 }}
        ...
        <h6 className={styles.form__title_ru}>
          Введи свои контактные данные,
          <br />
          чтобы получить PDF-презентацию
        </h6>
        <ACForm
          isMobile={isMobile}

...
const Page = () => {
   ...
   const businessCollection = [
     {
       ...
       slideTitle: ["Начало работы с", <br />, " 1 сентября 2024 года"],
       slideText: [
     ...
     },
     {
       ...
       slideText: [
         "находится на ул. Каля Ешилор,",
         <br className="hidden sm:inline-block" />,
         "  одной из важнейших магистралей ",
         <br className="hidden sm:inline-block" />,
         " Кишинева",
       ],
     },
     ...
     },
     {
       ...
       slideTitle: ["Профессиональный", <br />, " менеджмент"],
       slideText: [
         "управление и оперативная поддержка",
         <br className="hidden sm:inline-block" />,
         " с помощью системы Artima Helpdesk®,",
         <br />,
         " обеспечивающую безупречную",
         <br />,
         " функциональность",
       ],
     },
     {
       ...
       slideText: [
         "уникальный проект с элегантными",
         <br className="hidden sm:inline-block" />,
         " вестибюлями и высококачественной",
         <br className="hidden sm:inline-block" />,
         " отделкой, что создает эксклюзивную",
         <br />,
         " деловую атмосферу",
       ],
     },
  ...
  return (
    <div className={styles.wrapper_page}>
        ...
        <div className={styles.sale_head__content}>
          <div className={styles.sale_header__wrapper}>
            <h2 className={styles.head_content__title}>
              Продается эксклюзивный офис {""}
              <br className="hidden sm:inline-block " />
              площадью{" "}
              <span className={styles.head_content__title_decor}>
                978 м²
              </span>{" "}
              {""}
              <br className="inline-block sm:hidden" />
            ...
            <p className={styles.head_content__subtitle}>
              Последний доступный офис с {""}
              <br className="inline-block sm:hidden" />
              панорамным видом на 360 градусов
              <br className="hidden sm:inline-block" /> Расположен на первой
              линии, <br className="inline-block sm:hidden" />
              ул. Каля Ешилор
            </p>
      ...
      {isItemToggle && (
        <div
          className="w-full h-full absolute top-0 left-0 z-[3] bg-[#D9D9D9]/60"

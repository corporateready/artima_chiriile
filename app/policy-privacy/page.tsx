        ...
        <div className={styles.container}>
          <div className={styles.content}>
            <h2 className={styles.title}>
              Privacy Policy for "DUAL COMPANY" S.R.L.
            </h2>
            <p className={styles.text}>
              At ARTIMA Business & Lifestyle, accessible from artima.md, one of our
              ...
              and recorded by ARTIMA Business & Lifestyle and how we use it. If you
              ...
              and/or collect in ARTIMA Business & Lifestyle. This policy is not
            ...
            fraud By contacting the official representatives of ARTIMA Business & Lifestyle
            ...
            communication channels of the company, namely: WhatsApp, Viber,
            Telegram and e-mail, you automatically consent to the processing of
            your contact data (phone number) in advertising campaigns and
            receiving SMS mailings.
            </p>
            <h3 className={styles.subtitle}>Log Files</h3>
            <p className={styles.text}>
            ARTIMA Business & Lifestyle follows a standard procedure of using log
            ...
            <p className={styles.text}>
            Like any other website, ARTIMA Business & Lifestyle uses 'cookies'. These
            ...
            advertising partners of ARTIMA Business & Lifestyle. Third-party ad
            ...
            links that appear on ARTIMA Business & Lifestyle, which are sent directly
            ...
            Note that ARTIMA Business & Lifestyle has no access to or control over
            these cookies that are used by third-party advertisers.
            </p>
            <h3 className={styles.subtitle}>Third Party Privacy Policies</h3>
            <p className={styles.text}>
            ARTIMA Business & Lifestyle's Privacy Policy does not apply to other
            ...
            ARTIMA Business & Lifestyle does not knowingly collect any Personal

...
import Header from "../components/header-terms/page";
          ...
          <div className={styles.container}>
            <div className={styles.content}>
              ...
              <p className={styles.text}>
                Welcome to ARTIMA Business & Lifestyle!
                <br />
                <br />
                These terms and conditions outline the rules and regulations for
                the use of "DUAL COMPANY" S.R.L.'s Website, located at
                artima.md.
                <br />
                <br />
                By accessing this website we assume you accept these terms and
                conditions. Do not continue to use ARTIMA Business & Lifestyle
              ...
              <p className={styles.text}>
                We employ the use of cookies. By accessing ARTIMA Business &
                Lifestyle, you agreed to use cookies in agreement with the "DUAL
                COMPANY" S.R.L. Privacy Policy.
                <br />
                <br />
              ...
              <p className={styles.text}>
                Unless otherwise stated, "DUAL COMPANY" S.R.L. and/or its
                licensors own the intellectual property rights for all material
                on ARTIMA Business & Lifestyle. All intellectual property rights
                are reserved. You may access this from ARTIMA Business &
                Lifestyle for your own personal use subjected to restrictions
                ...
                <br />
                <br />
                Republish material from ARTIMA Business & Lifestyle Sell, rent
                or sub-license material from ARTIMA Business & Lifestyle
                Reproduce, duplicate or copy material from ARTIMA Business &
                Lifestyle Redistribute content from ARTIMA Business & Lifestyle
                Parts of this website offer an opportunity for users to post and
                exchange opinions and information in certain areas of the
                website. "DUAL COMPANY" S.R.L. does not filter, edit, publish or
                review Comments prior to their presence on the website. Comments
                do not reflect the views and opinions of "DUAL COMPANY"
                S.R.L.,its agents and/or affiliates. Comments reflect the views
                and opinions of the person who post their views and opinions. To
                the extent permitted by applicable laws, "DUAL COMPANY" S.R.L.
                ...
                <br />
                <br />
                "DUAL COMPANY" S.R.L. reserves the right to monitor all Comments
                ...
                activity. You hereby grant "DUAL COMPANY" S.R.L. a non-exclusive
                license to use, reproduce, edit and authorize others to use,
                reproduce and edit any of your Comments in any and all forms,
                formats or media.
              </p>
              <h3 className={styles.subtitle}>Hyperlinking to our Content</h3>
              <p className={styles.text}>
                ...
                visibility of the hyperlink compensates the absence of "DUAL
                COMPANY" S.R.L. and (d) the link is in the context of general
                ...
                by sending an e-mail to "DUAL COMPANY" S.R.L. Please include
                ...
                "DUAL COMPANY " S.R.L.'s logo or other artwork will be allowed
                for linking absent a trademark license agreement.
              </p>
              <h3 className={styles.subtitle}>iFrames</h3>
              <p className={styles.text}>
              ...
              <h3 className={styles.subtitle}>Content Liability</h3>
              <p className={styles.text}>
              ...
              <h3 className={styles.subtitle}>Your Privacy</h3>
              <p className={styles.text}>
                Please read{" "}
                <Link
                  href={"/policy-privacy"}
                  className="text-[#003784] underline"
                >
                  Privacy Policy
                </Link>
              </p>
              <h3 className={styles.subtitle}>Reservation of Rights</h3>
              <p className={styles.text}>
              ...
              <h3 className={styles.subtitle}>Disclaimer</h3>
              <p className={styles.text}>
